...
public class HouseModeTest {
    ...
    public HouseModeTest(String[] house_pic, String house_id, String house_hash, String owner_id, boolean verify, String owner, String owner_name, int role, int state, LowLocation low_location, String specific_location, int floor, boolean elevator, int lease, int lease_inter, int lease_type, int house_type, int house_owner_credit, double house_level, HouseComment[] house_comment) {
